...
namespace StockAnalyzer.Util
{
    ...
    public class HttpUtilManager : Singleton<HttpUtilManager>
    {
        ...
        public void requestHttpGetAsync(String url, String param, HttpAsyncReq.ResponseCallback callback)
        {
            HttpAsyncReq req = new HttpAsyncReq();
            req.requestHttpGetAsync(url, param, callback);
        }

        public void requestHttpPostAsync(String url, Dictionary<String, String> paras, HttpAsyncReq.ResponseCallback callback)
        {
            HttpAsyncReq req = new HttpAsyncReq();
            req.requestHttpPostAsync(url, paras, callback);
        }
    }
}
